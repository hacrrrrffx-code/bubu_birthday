...
const SmallLetter = () => {
    ...
    const handleToggleLetter = () => {
        ...
        if (isOpen) {
            ...
            letterElement.classList.remove('small-rajib-letter--close');
            // 2. Set state to open (which adds 'small-letter--open')
            setIsOpen(true);
        }
    };
    ...
    <div className="small-rajib-paper-content">
        ...
        <p>Hello Jaan💗,<br /><br />Happy Birthday🎂❤️😘May your smile always stay this beautiful and your heart always stay happy.🫶I hope this year brings you everything your heart quietly wishes for.✨And may I always get to see you smile a little more every day.❤️🥹🤌🏻🥳 <br /><br />Akash</p>
    </div>
